...
<svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet" {{ $attributes->class([
    'envalert-text-blue-700' => $color === 'blue',
    'envalert-text-purple-700' => $color === 'purple',
    'envalert-text-green-700' => $color === 'green',
    'envalert-text-red-700' => $color === 'red',
    'envalert-text-yellow-700' => $color === 'yellow',
    'envalert-text-amber-700' => $color === 'amber',
    'envalert-text-orange-700' => $color === 'orange',
    'envalert-text-indigo-700' => $color === 'indigo',
    'envalert-text-gray-700' => $color === 'gray',
]) }}>
