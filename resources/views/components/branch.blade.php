...
<svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet" {{ $attributes->class([
    'envbar-text-blue-700' => $color === 'blue',
    'envbar-text-purple-700' => $color === 'purple',
    'envbar-text-green-700' => $color === 'green',
    'envbar-text-red-700' => $color === 'red',
    'envbar-text-yellow-700' => $color === 'yellow',
    'envbar-text-amber-700' => $color === 'amber',
    'envbar-text-orange-700' => $color === 'orange',
    'envbar-text-indigo-700' => $color === 'indigo',
    'envbar-text-gray-700' => $color === 'gray',
]) }}>
